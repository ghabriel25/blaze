...
test('wraps component templates into function definitions', function () {
    ...
    expect($wrapped)->toEqualCollapsingWhitespace(join('', [
        ...
        '$attributes = new \Illuminate\View\ComponentAttributeBag($attributes->all()); ',
        '} else { ',
...
test('compiles aware props', function () {
    ...
    expect($wrapped)->toEqualCollapsingWhitespace(join('', [
        ...
        '$type = $__view ? $__env->getConsumableComponentData(\'type\', $__awareDefaults[\'type\']) : $__blaze->getConsumableData(\'type\', $__awareDefaults[\'type\']); ',
